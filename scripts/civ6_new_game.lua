...
MapConfiguration.SetValue('RANDOM_SEED', setup.map_seed or 6100910)
GameConfiguration.SetValue('GAME_SYNC_RANDOM_SEED', setup.game_seed or 6100911)
...
GameConfiguration.SetParticipatingPlayerCount(setup.combat and 2 or 1)
...
if setup.combat then
  local other=PlayerConfigurations[1]
  other:SetLeaderTypeName('LEADER_CLEOPATRA')
  other:SetCivilizationTypeName('CIVILIZATION_EGYPT')
  other:SetSlotStatus(SlotStatus.SS_COMPUTER)
end
